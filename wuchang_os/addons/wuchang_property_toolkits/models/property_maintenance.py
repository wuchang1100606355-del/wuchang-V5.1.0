...
class PropertyMaintenance(models.Model):
    ...
    # [STAPS] Broadcast Event
    if StapsKernelService:
        try:
            print(f'[STAPS] Property Maintenance Submitted: {self.name}')
        except Exception:
            pass
